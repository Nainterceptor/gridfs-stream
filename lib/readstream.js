...
GridReadStream.prototype._open = function _open() {
    var self = this;
    this._store.open(function (err, GridFile) {
...
GridReadStream.prototype._read = function _read(GridFile) {
    ...
    var self = this;
    GridFile.seek(self.start, function () {
        var stream = self._stream = GridFile.stream(true);
